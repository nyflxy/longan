...
class WxPayConf_pub(object):
    ...
    APPID = "wx5265b3c0067c5b20"
    #JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    APPSECRET = "3481d9b19abe9d3d0c0b01a3e7064275"
    #受理商ID，身份标识
    MCHID = "1262395201"
    #商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    KEY = "nf6h6df65149b8v461mn6j13g1n7hf69"


    #=======【异步通知url设置】===================================
    #异步通知url，商户根据实际开发过程设定
    NOTIFY_URL = "https://www.childstar.com/api/notify/wxpay"
    ...
    SSLCERT_PATH = "/usr/share/nginx/childstar/vendor/wxpay/keys/apiclient_cert.pem"
    SSLKEY_PATH = "/usr/share/nginx/childstar/vendor/wxpay/keys/apiclient_key.pem"
...
class Wxinfo_pub(Common_util_pub):
    ...
    def create_get_media_url(self,media_id):
        return "https://api.weixin.qq.com/cgi-bin/media/get?access_token=%s&media_id=%s"%(self.get_access_token(),media_id)
